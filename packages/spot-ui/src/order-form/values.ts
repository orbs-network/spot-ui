...
const getInputAmountPerTrade = (inputAmount = "", totalTrades = 0): string => {
...
const getOrderType = (module: Module, isMarketOrder: boolean): OrderType => {
...
const getTradePrice = ({
  ...
  CalculateOrderValuesParams,
  "module" | "isMarketOrder" | "marketPrice" | "limitPrice" | "triggerPrice"
>): string => {
